...
public class ExemploMetodosString
{
    ...
    private static void testaOutrosMetodosString (String nome)
    {
        ...
        // indexOf (String) = retorna o indice da primeira ocorrencia do char ou String informado
        String alfabeto = "abcdefghijklmnopqrstuvwyz";
        System.out.printf ("A letra 'm' está localizada no indice %d do alfabeto. \n", alfabeto.indexOf ('m'));
        
        // lastIndexOf () = retorna o indice da ultima ocorrencia do char ou String informado
        String fruta = "Banana";
        System.out.printf ("O último indice da letra 'n' na palavra %s está no valor %d \n", fruta, fruta.lastIndexOf ('n'));
        
        // replace () = substitui todas ocorrencias de um char ou string informado pelo segundo char ou string informado
        System.out.printf ("Nome atual = %s \n", nome);
        nome = nome.replace ('e', 'i');
        System.out.printf ("Nome depois do replace () = %s \n", nome);
        
        // Substring () = pega uma string a partir de um indice informado podendo ter ou não outro indice de fim
